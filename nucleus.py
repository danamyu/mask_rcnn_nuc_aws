...
#DEFAULT_LOGS_DIR = os.path.join(ROOT_DIR, "logs") #TODO re-enable if training locally
#ROOT_DIR_LOGS = os.path.abspath("logs")
#DEFAULT_LOGS_DIR = os.path.join(ROOT_DIR+"\samplesnucleus", "logs")
DEFAULT_LOGS_DIR= "/dltraining/checkpoints"
...
if __name__ == '__main__':
    ...
    print("default logs dir", DEFAULT_LOGS_DIR)
    ...
    ## Load weights TODO: UNCOMMENT FOR REG SCRIPT
